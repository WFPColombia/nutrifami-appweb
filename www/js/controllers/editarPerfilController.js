/*global angular*/
nf2.controller('EditarPerfilController', function($scope, $location, $filter, PerfilService, $anchorScroll, bsLoadingOverlayService, $timeout, UsuarioService) {
    'use strict';
...
nf2.filter('capitalize', function() {
    'use strict';
