/*global angular*/
nf2.controller('UnidadController', function($scope, $rootScope, $location, $routeParams, $anchorScroll, $timeout, $uibModal, ngAudio, bsLoadingOverlayService, UsuarioService, CapacitacionService) {
    'use strict';
...
nf2.directive('opcionesUnidadInfo', function() {
    return {
        restrict: 'E',
        scope: {
            info: '=',
