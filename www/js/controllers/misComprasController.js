nf2.controller('misComprasController', function($scope, $timeout, $location, $uibModal, $anchorScroll, ComprasService, ngAudio, bsLoadingOverlayService, UsuarioService) {
    'use strict';
