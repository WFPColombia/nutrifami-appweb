/*global angular*/
nf2.controller('LeccionTerminadaController', function($scope, $location, $anchorScroll, $routeParams, bsLoadingOverlayService, ngAudio, UsuarioService, $uibModal, CapacitacionService) {
    'use strict';
